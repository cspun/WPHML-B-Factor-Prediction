...
float_range = np.linspace(.5, 1.0, 6)
#float_range = np.linspace(.6, 1.0, 5)
bin_sizes = [0.1]

for euclidean_distance in [40]:
    ...
    common_atoms = [f for f in short_names[0] if f in short_names[1] and f in short_names[2] and f in short_names[3]]
        ...
        for bin_size in bin_sizes:
            ...
            for common_atom in common_atoms:
                ...
                indexes = [short_names[0].index(common_atom), short_names[1].index(common_atom), 
                            short_names[2].index(common_atom), short_names[3].index(common_atom)]
