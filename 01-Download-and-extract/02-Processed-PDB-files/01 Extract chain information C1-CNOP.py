	...
	if chain in file_extension.keys():
		...
		if file_extension[chain] == "pdb":
			for j in RNAchains_dict[chain]:
				...
				for line in oldfile:
					if line:
						if line[0:4] == "ATOM" and line[21] == j and (line[13:16] == "C1'" or line[77] == letter):
							newfile.write(line)
		...
		# This portion is for cif files
			...
			for j in RNAchains_dict[chain]:
				...
				for line in oldfile:
					if line:
						if line[0:4] == "ATOM" and j in line[90:95].split(" ") and (line[18:21] == "C1'" or line[14] == letter):
							newfile.write(line)
