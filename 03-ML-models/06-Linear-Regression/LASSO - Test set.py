...
writer = pd.ExcelWriter(os.path.join(main_folder, subfolder_output_results, 
                        str(datetime.datetime.today().date()) + " Lasso results - Test set - %s.xlsx" %letter))
...
#input_files = ["C-N-O-P_25_12.5_0.5_25.csv"]
input_files = ["C1-O_25_12.5_0.5_25.csv"]
...
for file in input_files:
    ...
    # Train model 
    print(datetime.datetime.now(), "\tLASSO - Training %s" %(file))

    # Training
    clf = Lasso(alpha = alpha, random_state = seed, max_iter = 10000)
